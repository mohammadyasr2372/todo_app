    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `Task` (`id` INTEGER, `userId` INTEGER, `todo` TEXT, `completed` INTEGER, PRIMARY KEY (`id`))');
...
class _$TaskDao extends TaskDao {
  ...
  @override
  Future<void> insertTask(TaskModel newTaskMode) async {
    await _taskModelInsertionAdapter.insert(
        newTaskMode, OnConflictStrategy.abort);
  }

  @override
  Future<void> deletTask(TaskModel newTaskMode) async {
    await _taskModelDeletionAdapter.delete(newTaskMode);
  }
}
